...
export class ViewComponent implements OnInit {
  ...
  data:Item[]=[
    ...
    },
    {
      ...
      imageSrc: 'https://media.istockphoto.com/photos/casablanca-mosque-picture-id544676786?k=20&m=544676786&s=612x612&w=0&h=yxMfcOWTxIDJy98vfLl57g8kYcC_GwagrPzCxXI5fC0=',
      imageAlt: '14'
    }, {
      imageSrc: 'https://media.istockphoto.com/photos/casablanca-mosque-picture-id544676786?k=20&m=544676786&s=612x612&w=0&h=yxMfcOWTxIDJy98vfLl57g8kYcC_GwagrPzCxXI5fC0=',
      imageAlt: '15'
  ...
  ngOnInit() {
    ...
    this.showmask_sidebar =this.galleryService.getshowMask();
    this.galleryService.showmaskemmiter.subscribe((showmask_sidebar:boolean )=>{
      this.showmask_sidebar=showmask_sidebar;
    })
  }
